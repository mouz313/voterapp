...
@section('content')
    ...
    <h4 class="page-title mb-3">Edit Block Code</h4>
            ...
            <form method="POST" action="{{ route('block-codes.update', $blockCode) }}">
                ...
                <div class="mb-3">
                    ...
                    <select name="uc_id" class="form-select @error('uc_id') is-invalid @enderror" required>
                        @foreach ($ucs as $uc)
                            <option value="{{ $uc->id }}" {{ (old('uc_id', $blockCode->uc_id) == $uc->id) ? 'selected' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="code" value="{{ old('code', $blockCode->code) }}" class="form-control @error('code') is-invalid @enderror" required>
